        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
               ...
               @endif
                ...
                <form role="form" accept="{{url('pengajuan/add')}}" method="post" enctype="multipart/form-data">
                    @csrf
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="usia" class="form-control" id="exampleInputPassword1" placeholder="Usia">
                    </div>
                    @if(\Auth::user()->status == 1)
                    <div class="form-group">
                      <label for="exampleInputPassword1">Catatan</label>
                      <input type="text" name="catatan" class="form-control" id="exampleInputPassword1" placeholder="Catatan">
                    </div>
                    @endif

                    <div class="form-group">
                      <label for="exampleInputPassword1">Tempat Tanggal Lahir</label>
                      <input type="text" name="ttl" class="form-control" id="exampleInputPassword1" placeholder="Tempat Tanggal Lahir">
                    </div>
